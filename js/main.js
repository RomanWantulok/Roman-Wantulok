...
(function(html) {
    ...
    * ------------------------------------------------------ */
    ...
    document.addEventListener("DOMContentLoaded", function () {
        // Pokud ještě není uložen jazyk, detekujeme jej z prohlížeče
        if (!localStorage.getItem("selectedLanguage")) {
          // Získá jazyk z navigator.language nebo navigator.userLanguage (pro IE)
          const browserLang = navigator.language || navigator.userLanguage;
          // Pokud začíná na "cs", nastavíme češtinu, jinak angličtinu
          const defaultLang = browserLang.toLowerCase().startsWith("cs") ? "cs" : "en";
          localStorage.setItem("selectedLanguage", defaultLang);
        }
        
        // Načteme uložený jazyk a nastavíme jej
        const savedLanguage = localStorage.getItem("selectedLanguage");
        setLanguage(savedLanguage);
      
        // Připojíme posluchače k tlačítkům persistentního přepínače (i případně dalším, pokud je máte)
        ...
        // Vaše další kódy (pokud máte další inicializaci)...
        
        // Funkce, která aktualizuje všechny texty na stránce na základě vybraného jazyka.
        function setLanguage(lang) {
          // Objekt s překlady – rozšiřte dle potřeby všechny texty, které se mají měnit
          const translations = {
            "en": {
              "navIntro": "Intro",
              "navAbout": "About",
          ...
          // Aktualizujeme všechny elementy, které mají atribut data-key
